...
// Used throughout career pages for a polished, enterprise-level design
...
export const RoadmapIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    <path d="M12 2v6m0 4v6M6 8h12M6 18h12" />
...
export const CourseIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
...
export const InterviewIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    <circle cx="12" cy="12" r="1" fill={color} />
    <circle cx="12" cy="5" r="2" />
    <path d="M8 10h8M6 14h12M9 18h6" />
    <rect x="2" y="2" width="20" height="20" rx="2" />
  </svg>
);

export const PlannerIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    <rect x="3" y="4" width="18" height="18" rx="2" />
    <path d="M16 2v4M8 2v4M3 10h18M7 14h10M7 18h10" />
  </svg>
);

export const ProgressIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" />
    <path d="M12 6v6l4 2.5" fill="none" />
  </svg>
);
...
export const ChartIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    ...
    <path d="M17 5h4v14h-4M3 18h4V9h4M11 13h4V5h4" />
  </svg>
);
...
export const AwardIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    ...
    <polyline points="8 14 8 21 16 21 16 14" />
...
export const SettingsIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
    <circle cx="12" cy="12" r="3" />
    <path d="M12 1v6m0 6v6M4.22 4.22l4.24 4.24m6.08 0l4.24-4.24M1 12h6m6 0h6m-3.78 7.78l-4.24-4.24m-6.08 0l-4.24 4.24" />
  </svg>
);
...
export const CatalystIcon = ({ size = 24, color = "currentColor" }) => (
